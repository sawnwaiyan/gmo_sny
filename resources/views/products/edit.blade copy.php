    ...
    <div class="container">
        ...
        <div x-data="productForm({{ json_encode($product) }})" class="bg-white shadow-md rounded-lg p-6 m-4 max-w-2xl w-full">
            ...
            <form @submit.prevent="submitForm" enctype="multipart/form-data">
                @csrf
                <!-- No need for @method('PUT') since we'll use POST method -->
            ...
            return {
                ...
                handleFileChange(event) {
                    ...
                    if (file) {
                        if (file.type.startsWith('image/')) {
                            ...
                            this.formData.product_image = null; // Clear the existing image URL when a new file is selected
                        } else {
                ...
                async submitForm() {
                    ...
                    if (this.isFormValid) {
                        ...
                        let method = 'post'; // Use POST instead of PUT
